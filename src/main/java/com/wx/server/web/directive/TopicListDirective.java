...
public class TopicListDirective implements TemplateDirectiveModel {
  ...
  public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body)
    ...
    List<TbTopic> list = topicService.getListForTag(getCategoryId(params), getUserId(params), getValid(params),
        DirectiveUtils.getCount(params));

    Map<String, TemplateModel> paramWrap = new HashMap<String, TemplateModel>(params);
    paramWrap.put(DirectiveUtils.OUT_LIST, DirectiveUtils.getBeansWrapper().wrap(list));
